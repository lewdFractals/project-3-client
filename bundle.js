...
/***/ function(module, exports, __webpack_require__) {
	...
	var blogEvents = __webpack_require__(9);
	var pageEvents = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onLogOut = function onLogOut(event) {
	  event.preventDefault();
	  api.logOut().done(ui.logOutSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onPublicIndexBlogs = function onPublicIndexBlogs(event) {
	  event.preventDefault();
	  api.publicIndexBlogs().done(ui.publicIndexBlogsSuccess).fail(ui.failure);
	};

	var onCreateBlog = function onCreateBlog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createBlog(data).done(ui.createBlogSuccess).fail(ui.createBlogFail);
	};

	var onIndexBlogs = function onIndexBlogs(event) {
	  event.preventDefault();
	  api.indexBlogs().done(ui.indexBlogsSuccess).fail(ui.failure);
	};

	var onShowBlog = function onShowBlog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.showBlog(data).done(ui.success).fail(ui.failure);
	};

	var onEditBlog = function onEditBlog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.editBlog(data).done(function () {
	    ui.success();
	    onIndexBlogs(event);
	  }).fail(ui.failure);
	};
	...
	var onDeleteBlog = function onDeleteBlog(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deleteBlog(data).done(function () {
	    ui.success();
	    onIndexBlogs(event);
	  }).fail(ui.failure);
	};

	var onToggleBlogOptions = function onToggleBlogOptions(event) {
	  event.preventDefault();
	  var id = $(event.target).attr("data-blog-id");
	  $('#' + id).slideToggle("slow");
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var publicIndexBlogs = function publicIndexBlogs() {
	  return $.ajax({
	    url: app.host + '/blogs',
	    method: 'GET'
	  });
	...
	var indexBlogs = function indexBlogs() {
	  var token = app.user.token;
	  return $.ajax({
	...
	var showBlog = function showBlog(data) {
	  var token = app.user.token;
	  var blog_id = data.blog._id;
	  return $.ajax({
	...
	var editBlog = function editBlog(data) {
	  var blog_id = data.blog._id;
	  var token = app.user.token;
	  return $.ajax({
	    url: app.host + '/blogs/' + blog_id,
	...
	var deleteBlog = function deleteBlog(data) {
	  var token = app.user.token;
	  var blog_id = data.blog._id;
	  return $.ajax({
	    url: app.host + '/blogs/' + blog_id,
	...
	module.exports = {
	  ...
	  publicIndexBlogs: publicIndexBlogs,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexBlogsTemplate = __webpack_require__(12);
	var publicIndexBlogsTemplate = __webpack_require__(32);

	var clearForm = function clearForm() {
	  $('input').val('');
	};

	var clearTinyMCE = function clearTinyMCE() {
	...
	var createBlogFail = function createBlogFail() {
	...
	var publicIndexBlogsSuccess = function publicIndexBlogsSuccess(blogs) {
	  $('.public-display').html(publicIndexBlogsTemplate(blogs));
	};

	var indexBlogsSuccess = function indexBlogsSuccess(blogs) {
	...
	module.exports = {
	  ...
	  createBlogFail: createBlogFail,
	  publicIndexBlogsSuccess: publicIndexBlogsSuccess,
	  indexBlogsSuccess: indexBlogsSuccess,
	  success: success,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <h4 class=\"border-top\">\n    "
	    ...
	    + "</h5>\n\n  <button type=\"button\" class=\"btn-xs options-button\" id=\"blog-options-button\" data-blog-id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + ">Options</button>\n\n<div class=\"blog-options\" id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + ">\n    <!-- Update Blog -->\n    <div id=\"edit-form\">\n     <form id=\"edit-blog\">\n       <fieldset>\n         <input type=\"hidden\" name=\"blog[_id]\" value=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n         <div class=\"form-group\">\n           <input type=\"text\" class=\"form-control\" name=\"blog[title]\" value=\""
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "\" required>\n         </div>\n         <div class=\"form-group\">\n           <textarea class=\"form-control text-editor\" name=\"blog[content]\" rows=\"10\" cols=75 required>"
	    + ((stack1 = ((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"content","hash":{},"data":data}) : helper))) != null ? stack1 : "")
	    + "</textarea>\n         </div>\n         <button type=\"submit\" class=\"btn btn-default pull-right\" name=\"submit\">Submit Edit</button>\n       </fieldset>\n     </form>\n     </div>\n\n   <!-- Delete Blog -->\n   <div id=\"delete-form\">\n    <form id=\"delete-blog\">\n      <input type=\"hidden\" name=\"blog[_id]\" value=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n      <button type=\"submit\" name=\"submit\" class=\"btn btn-default pull-right\">Delete Blog Post</button>\n    </form>\n  </div>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = 
	  "<h2> Blog Posts </h2>\n";
	  stack1 = ((helper = (helper = helpers.blogs || (depth0 != null ? depth0.blogs : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"blogs","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.blogs) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onCreatePage = function onCreatePage(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createPage(data).done(ui.createPageSuccess).fail(ui.createPageFail);
	};

	var onIndexPages = function onIndexPages(event) {
	  event.preventDefault();
	  api.indexPages().done(ui.indexPagesSuccess).fail(ui.failure);
	};

	var onShowPage = function onShowPage(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.showPage(data).done(ui.showPageSuccess).fail(ui.failure);
	};

	var onEditPage = function onEditPage(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.editPage(data).done(function () {
	    ui.success();
	    onIndexPages(event);
	  }).fail(ui.failure);
	};
	...
	var onDeletePage = function onDeletePage(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.deletePage(data).done(function () {
	    ui.success();
	    onIndexPages(event);
	  }).fail(ui.failure);
	};

	var onTogglePageOptions = function onTogglePageOptions(event) {
	  event.preventDefault();
	  var id = $(event.target).attr("data-page-id");
	  $('#' + id).slideToggle("slow");
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexPages = function indexPages() {
	  var token = app.user.token;
	  return $.ajax({
	    url: app.host + '/pages',
	    method: 'GET',
	...
	var showPage = function showPage(data) {
	  var token = app.user.token;
	  var page_id = data.page._id;
	  return $.ajax({
	...
	var editPage = function editPage(data) {
	  var page_id = data.page._id;
	  var token = app.user.token;
	  return $.ajax({
	    url: app.host + '/pages/' + page_id,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexPagesTemplate = __webpack_require__(36);
	var showPageTemplate = __webpack_require__(37);
	...
	var createPageFail = function createPageFail() {
	  document.getElementById("message").innerHTML = 'You failed to put text in all the required fileds. Please enter all the required text.';
	  displayMessage();
	};

	var indexPagesSuccess = function indexPagesSuccess(pages) {
	  $('.content-display').html(indexPagesTemplate(pages));
	};

	var showPageSuccess = function showPageSuccess(page) {
	...
	module.exports = {
	  ...
	  createPageFail: createPageFail,
	  indexPagesSuccess: indexPagesSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <h4 class=\"border-top\">\n    "
	    ...
	    + "\n  </h4>\n  <p>\n    "
	    + ((stack1 = ((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"content","hash":{},"data":data}) : helper))) != null ? stack1 : "")
	    + "\n  </p>\n\n  <button type=\"button\" class=\"btn-xs options-button\" id=\"page-options-button\" data-page-id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + ">Options</button>\n\n  <div class=\"page-options\" id="
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + ">\n  <!-- Show Page -->\n  <div class=\"show-page-option\">\n  <form id=\"show-page\">\n     <input type=\"hidden\" name=\"page[_id]\" value=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n     <button type=\"submit\" name=\"submit\" class=\"btn btn-default pull-right\">Show This Page</button>\n   </form>\n </div>\n\n  <!-- Edit Page -->\n  <div class=\"edit-page-option\">\n  <form id=\"edit-page\">\n     <fieldset>\n       <input type=\"hidden\" name=\"page[_id]\" value=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n       <div class=\"form-group\">\n         <input type=\"text\" class=\"form-control\" name=\"page[header]\" value=\""
	    + alias4(((helper = (helper = helpers.header || (depth0 != null ? depth0.header : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"header","hash":{},"data":data}) : helper)))
	    + "\" required>\n       </div>\n       <div class=\"form-group\">\n         <textarea class=\"form-control text-editor\" name=\"page[content]\" rows=\"10\" cols=75 required>"
	    + ((stack1 = ((helper = (helper = helpers.content || (depth0 != null ? depth0.content : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"content","hash":{},"data":data}) : helper))) != null ? stack1 : "")
	    + "</textarea>\n       </div>\n       <button type=\"submit\" class=\"btn btn-default pull-right\" name=\"submit\">Submit Edit</button>\n     </fieldset>\n   </form>\n </div>\n\n <!-- Delete Page -->\n <div class=\"delete-page-option\">\n <form id=\"delete-page\">\n   <input type=\"hidden\" name=\"page[_id]\" value=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">\n   <button type=\"submit\" name=\"submit\" class=\"btn btn-default pull-right\">Delete Page</button>\n </form>\n </div>\n </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1, helper, options, buffer = 
	  "<h2> Pages </h2>\n";
	  stack1 = ((helper = (helper = helpers.pages || (depth0 != null ? depth0.pages : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"pages","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"page-header\">\n  <h4>\n    "
	    ...
	    + alias4(((helper = (helper = helpers.sidebar || (depth0 != null ? depth0.sidebar : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"sidebar","hash":{},"data":data}) : helper)))
	  ...
	  stack1 = ((helper = (helper = helpers.page || (depth0 != null ? depth0.page : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"page","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.page) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer;
	},"useData":true});
